...
class OmarOpenlayersPluginGrailsPlugin extends Plugin {
   ...
   // URL to the plugin's documentation
       def documentation = "https://grails.github.io/OmarOpenlayersPlugin/"
   ...
   //    def issueManagement = [ system: "GitHub", url: "https://github.com/grails/OmarOpenlayersPlugin/issues" ]

       // Online location of the plugin's browseable source code.
   //    def scm = [ url: "https://github.com/grails/OmarOpenlayersPlugin" ]
